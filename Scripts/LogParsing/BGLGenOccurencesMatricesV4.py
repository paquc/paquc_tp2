...
def GenMatrices():
    ...
    with open(f"./BGL_Brain_results/KERNDTLB_alarm_sequences_V4.csv", "w") as sequences_output_file:
    ...
    remove_duplicates("./BGL_Brain_results/KERNDTLB_alarm_sequences_V4.csv", "./BGL_Brain_results/KERNDTLB_alarm_sequences_V4_dedup.csv")
    ...
    sequences_file = "./BGL_Brain_results/KERNDTLB_alarm_sequences_V4_dedup.csv"
    ...
    matrix_output_file_path = "./BGL_Brain_results/KERNDTLB_alarm_occurences_matrix_V4.csv"
...
print("Matrices V4 generated successfully!")
