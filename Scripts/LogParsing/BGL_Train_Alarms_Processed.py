...
slide_window_suffix = f"{window_size}_{TH}"
...
input_file_path = f"./BGL_Brain_results/BGL_{slide_window_suffix}_alarm_occurences_matrix_preprocessed{file_suffix}.csv"
...
sub_folder = f"BGL_Train_Aggregate_{n_bootstrap_samples}_{slide_window_suffix}"
...
with open(f"./BGL_Brain_results/{sub_folder}/{slide_window_suffix}_Training_Set_RF_{sampling_data_desc}_FixWindow_Output{file_suffix}.log", "w") as RF_log_file, open(f"./BGL_Brain_results/{sub_folder}/{slide_window_suffix}_Training_Set_LR_{sampling_data_desc}_FixWindow_Output{file_suffix}.log", "w") as LR_log_file:
