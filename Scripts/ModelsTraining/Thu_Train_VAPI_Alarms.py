...
if len(sys.argv) < 2:
    print("Usage: missing version number argument")
    sys.exit(1)
...
data = pd.read_csv(f"./Thunderbird_Brain_results/VAPI_alarm_occurences_matrix_{input_version}_dedup.csv")
...
with open(f"./Thunderbird_Brain_results/Thu_VAPI_Training_{input_version}_Output.log", "w") as log_file:
