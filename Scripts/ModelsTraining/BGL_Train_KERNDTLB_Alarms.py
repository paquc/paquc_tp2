...
data = pd.read_csv(f"./BGL_Brain_results/KERNDTLB_alarm_occurences_matrix_{input_version}_dedup.csv")
...
with open(f"./BGL_Brain_results/BGL_KERNDTLB_Trainig_{input_version}_Output.log", "w") as log_file:
