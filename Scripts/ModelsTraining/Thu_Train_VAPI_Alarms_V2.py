...
if len(sys.argv) > 3:
    ...
    train_RF = int(sys.argv[2])     # 1 to train RF and 0 to train LR
    train_LR = int(sys.argv[3])     # 1 to train LR and 0 to train RF
else:
...
with open(f"./Thunderbird_Brain_results/Thu_VAPI_Training_V4_Set_{n_data_set_id}_RF_80_20_Output.log", "w") as RF_log_file, open(f"./Thunderbird_Brain_results/Thu_VAPI_Training_V4_Set_{n_data_set_id}_LR_80_20_Output.log", "w") as LR_log_file:
